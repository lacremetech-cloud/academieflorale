...
.af-bg{position:fixed;inset:0;z-index:-4;overflow:hidden;background:linear-gradient(180deg,#FFFDF8 0%, #FAF6EE 55%, #F5F0E6 100%);}
.af-bg-fx{position:fixed;inset:0;z-index:-4;pointer-events:none;background:
  radial-gradient(ellipse 80% 50% at 50% 8%, rgba(246,75,12,.05) 0%, rgba(246,75,12,.02) 30%, transparent 60%),
  radial-gradient(ellipse 60% 45% at 86% 82%, rgba(255,138,61,.05) 0%, transparent 50%),
...
/* TRUST */
.trust{position:relative;z-index:2;border-top:1px solid var(--line);border-bottom:1px solid var(--line);background:rgba(255,255,255,.7);}
...
/* FOOTER */
footer{position:relative;z-index:2;background:rgba(255,255,255,.85);border-top:1px solid var(--line);padding:36px 0;}
...
.webin-cta-meta{font-size:13px;color:var(--muted);margin-top:10px;}
.webin-photo{position:relative;}
.webin-photo .frame{position:relative;border-radius:220px 220px 18px 18px;overflow:hidden;aspect-ratio:3/3.7;box-shadow:0 44px 90px -42px rgba(70,40,15,.5);}
.webin-photo .frame img{width:100%;height:100%;object-fit:cover;}
.webin-photo .live-pill{position:absolute;right:-14px;bottom:36px;background:var(--card);border-radius:100px;padding:11px 18px;box-shadow:0 18px 40px -16px rgba(70,40,15,.45);display:flex;align-items:center;gap:10px;font-size:13px;font-weight:500;}
.webin-photo .live-pill .dot{width:9px;height:9px;border-radius:50%;background:#FF3B30;box-shadow:0 0 0 4px rgba(255,59,48,.22);animation:liveBlink 1.4s ease-in-out infinite;}
.webin-thumb{display:none;}
.webin-countdown{display:flex;justify-content:flex-start;gap:10px;margin-top:18px;}
...
.webin-proof{position:relative;z-index:2;background:rgba(255,255,255,.78);border-top:1px solid var(--line);border-bottom:1px solid var(--line);}
...
@media(max-width:900px){
  .webin-hero{min-height:calc(100svh - 80px);padding:10px 0 22px;}
  ...
  .webin-countdown{justify-content:center;margin-top:14px;}
  .webin-cta-meta{text-align:center;}
}
...
<section class="webin-hero"><div class="wrap"><div class="webin-hero-grid">
  <div class="webin-copy">
    ...
    <div class="webin-thumb"><img src="/assets/img/hero-sybile.jpg" alt=""></div>
  ...
  <div class="webin-photo reveal">
    <div class="frame"><img src="/assets/img/hero-sybile.jpg" alt="Sybile Loppe avec un bouquet" fetchpriority="high"></div>
    <div class="live-pill"><span class="dot"></span> Live mardi 20h30</div>
  </div>
</div></div></section>
